...
class RecordController {
    ...
    private function handlePOST() {
        ...
        $relationship_record = $_POST['relationship_record'];
    
        $result = $this->createRecord($id_record, $date_record, $start_time, $end_time, $affair, $responsible, $privacy, $relationship_record);
